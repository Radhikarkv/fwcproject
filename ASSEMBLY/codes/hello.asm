.include "/home/student/Desktop/assembly/m328Pdef.inc"

	.def	00000001	= r16		; mask register
	.def	ledR 	= r17		; led register
	.def	oLoopR 	= r18		; outer loop register
	.def	iLoopRl = r24		; inner loop register low
	.def	iLoopRh = r25		; inner loop register high

	.equ	oVal 	= 0	;71	; outer loop value
	.equ	iVal 	= 0;28168		; inner loop value

	.cseg
	.org	0x00
	clr	ledR			; clear led register
	ldi	00000001,(1<<PINB5)		; load 00000001 into mask register
	out	DDRB,00000001		; set PINB0 to output

start:	eor	ledR,00000001		; toggle PINB0 in led register
